...
SpanNodeGeneratorWithTag artifactAntThinkingGenerator = SpanNodeGeneratorWithTag(
    tag: _artifactAntThinkingTag, generator: (e, config, visitor) => ArtifactAntThinkingNode(e.attributes, e.textContent, config));
...
SpanNodeGeneratorWithTag artifactAntArtifactGenerator = SpanNodeGeneratorWithTag(
    tag: _artifactAntArtifactTag, generator: (e, config, visitor) => ArtifactAntArtifactNode(e.attributes, e.textContent, config));
