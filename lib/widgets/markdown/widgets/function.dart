...
SpanNodeGeneratorWithTag functionGenerator =
    SpanNodeGeneratorWithTag(tag: _functionTag, generator: (e, config, visitor) => FunctionNode(e.attributes, e.textContent, config));
