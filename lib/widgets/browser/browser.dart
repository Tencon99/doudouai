...
import 'package:doudouai/utils/inappview.dart';
import 'dart:convert';
...
class BrowserViewState extends State<BrowserView> {
  ...
  Widget build(BuildContext context) {
    ...
    return IconButton(
      ...
      onPressed: () {
        browser.openUrlRequest(urlRequest: URLRequest(url: WebUri('http://google.com/search?q=${widget.url}')), settings: settings);
