...
import 'package:doudouai/provider/settings_provider.dart';
    ...
    try {
      ...
      if (kIsDesktop) {
        final path = await FilePicker.platform.saveFile(
          ...
          fileName: 'doudouAI-${ProviderManager.chatProvider.activeChat?.title ?? DateTime.now().millisecondsSinceEpoch}.jpg',
      ...
      if (kIsMobile) {
        ...
        final tempFile = io.File('${tempDir.path}/doudouAI_${safeTitle}_${DateTime.now().millisecondsSinceEpoch}.jpg');
        await tempFile.writeAsBytes(image);

        await SharePlus.instance.share(
          ShareParams(
            files: [XFile(tempFile.path)],
            subject: "doudouAI $title",
          ),
        );
      }
