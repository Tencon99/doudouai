...
import 'dart:convert';
import 'package:doudouai/widgets/collapsible_section.dart';
...
class ChatMessageContent extends StatelessWidget {
  ...
  Widget _buildMessage(BuildContext context) {
    ...
    return Column(
      crossAxisAlignment: message.role == MessageRole.user ? CrossAxisAlignment.end : CrossAxisAlignment.start,
      children: messages,
    );
  }
