...
import 'package:doudouai/page/setting/mcp_info.dart';
import 'package:doudouai/provider/mcp_server_provider.dart';
import 'package:doudouai/provider/serve_state_provider.dart';
    ...
    if (_error != null) {
      return [
        SizedBox(
          height: 40,
          child: Center(
            child: Text('Load failed: $_error', style: Theme.of(context).textTheme.bodyMedium),
          ),
        )
      ];
    }
    ...
    if (_cachedServers == null || _cachedServers!.isEmpty) {
      return [
        SizedBox(
          height: 40,
          child: Center(
            child: Text('No available servers', style: Theme.of(context).textTheme.bodyMedium),
          ),
        )
      ];
    }
